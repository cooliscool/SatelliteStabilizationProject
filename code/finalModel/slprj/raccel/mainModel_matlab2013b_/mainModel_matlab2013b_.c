...
real_T dkrturai3y_idx_1 ; real_T dkrturai3y_idx_2 ; if ( rtDW . ijwm01234w !=
0 ) { rtX . na0kwbhiuw [ 0 ] = rtB . adwnxz5ipz [ 0 ] ; rtX . na0kwbhiuw [ 1
] = rtB . adwnxz5ipz [ 1 ] ; rtX . na0kwbhiuw [ 2 ] = rtB . adwnxz5ipz [ 2 ]
; rtX . na0kwbhiuw [ 3 ] = rtB . adwnxz5ipz [ 3 ] ; } if ( ssIsMajorTimeStep
( rtS ) ) { if ( rtX . na0kwbhiuw [ 0 ] >= rtP . Integrator2_UpperSat ) { rtX
...
2 ] = rtB . exnul2rleq [ 2 ] ; } rtB . fdz33yjl0b [ 0 ] = rtP .
pitchrollyawdesired_Value [ 0 ] - rtX . kmrvp24iak [ 0 ] ; dkrturai3y_idx_1 =
rtX . kmrvp24iak [ 1 ] ; rtB . fdz33yjl0b [ 1 ] = rtP .
pitchrollyawdesired_Value [ 1 ] - rtX . kmrvp24iak [ 1 ] ; dkrturai3y_idx_2 =
rtX . kmrvp24iak [ 2 ] ; rtB . fdz33yjl0b [ 2 ] = rtP .
pitchrollyawdesired_Value [ 2 ] - rtX . kmrvp24iak [ 2 ] ; rtB . hn3ztypum0 =
rtP . Gain1_Gain * rtB . fdz33yjl0b [ 0 ] ; if ( ( rtDW . ak5rdpmsmz >=
ssGetT ( rtS ) ) && ( rtDW . c3ktouvv30 >= ssGetT ( rtS ) ) ) { dpr3yvxfcy =
0.0 ; } else { kxihzicqru = rtDW . ak5rdpmsmz ; lastU = & rtDW . foqrciusel ;
if ( rtDW . ak5rdpmsmz < rtDW . c3ktouvv30 ) { if ( rtDW . c3ktouvv30 <
ssGetT ( rtS ) ) { kxihzicqru = rtDW . c3ktouvv30 ; lastU = & rtDW .
goyla3ngee ; } } else { if ( rtDW . ak5rdpmsmz >= ssGetT ( rtS ) ) {
kxihzicqru = rtDW . c3ktouvv30 ; lastU = & rtDW . goyla3ngee ; } } dpr3yvxfcy
= ( rtB . hn3ztypum0 - * lastU ) / ( ssGetT ( rtS ) - kxihzicqru ) ; } rtB .
oy1dkzfhxx = ( dpr3yvxfcy + rtX . blaoeqyfri ) + rtP . Gain_Gain * rtB .
fdz33yjl0b [ 0 ] ; rtB . c2phj3ex1u = rtP . Gain1_Gain_jkygvdcm0j * rtB .
fdz33yjl0b [ 1 ] ; if ( ( rtDW . jj2dwxwohg >= ssGetT ( rtS ) ) && ( rtDW .
eealhk5q4c >= ssGetT ( rtS ) ) ) { dpr3yvxfcy = 0.0 ; } else { kxihzicqru =
rtDW . jj2dwxwohg ; lastU = & rtDW . fxofrcfu4n ; if ( rtDW . jj2dwxwohg <
rtDW . eealhk5q4c ) { if ( rtDW . eealhk5q4c < ssGetT ( rtS ) ) { kxihzicqru
= rtDW . eealhk5q4c ; lastU = & rtDW . mrsbfmqp2d ; } } else { if ( rtDW .
jj2dwxwohg >= ssGetT ( rtS ) ) { kxihzicqru = rtDW . eealhk5q4c ; lastU = &
rtDW . mrsbfmqp2d ; } } dpr3yvxfcy = ( rtB . c2phj3ex1u - * lastU ) / (
ssGetT ( rtS ) - kxihzicqru ) ; } rtB . adi0v32ets = rtP .
Gain1_Gain_akkqzazk2e * rtB . fdz33yjl0b [ 2 ] ; if ( ( rtDW . mruqdd4fxa >=
ssGetT ( rtS ) ) && ( rtDW . en5yifcisr >= ssGetT ( rtS ) ) ) { kxihzicqru =
0.0 ; } else { kxihzicqru = rtDW . mruqdd4fxa ; lastU = & rtDW . cg1m0nct3u ;
if ( rtDW . mruqdd4fxa < rtDW . en5yifcisr ) { if ( rtDW . en5yifcisr <
ssGetT ( rtS ) ) { kxihzicqru = rtDW . en5yifcisr ; lastU = & rtDW .
eivvrtbw1v ; } } else { if ( rtDW . mruqdd4fxa >= ssGetT ( rtS ) ) {
kxihzicqru = rtDW . en5yifcisr ; lastU = & rtDW . eivvrtbw1v ; } } kxihzicqru
= ( rtB . adi0v32ets - * lastU ) / ( ssGetT ( rtS ) - kxihzicqru ) ; }
dpr3yvxfcy = ( dpr3yvxfcy + rtX . eefvuab0yx ) + rtP . Gain_Gain_j0nwylexu1 *
rtB . fdz33yjl0b [ 1 ] ; kxihzicqru = ( kxihzicqru + rtX . awawpknawq ) + rtP
. Gain_Gain_hskt0iupyl * rtB . fdz33yjl0b [ 2 ] ; for ( i = 0 ; i < 4 ; i ++
) { rtB . eg1zksfhic [ i ] = 0.0 ; rtB . eg1zksfhic [ i ] += a [ i ] * rtB .
oy1dkzfhxx ; rtB . eg1zksfhic [ i ] += a [ i + 4 ] * dpr3yvxfcy ; rtB .
eg1zksfhic [ i ] += a [ i + 8 ] * kxihzicqru ; mcn21s5jdx [ i ] = rtP .
uI1_Gain * rtB . eg1zksfhic [ i ] ; } if ( rtDW . dw32h4dvva != 0 ) { rtX .
mz0jfaypkk [ 0 ] = rtB . k1felwmdht [ 0 ] ; rtX . mz0jfaypkk [ 1 ] = rtB .
k1felwmdht [ 1 ] ; rtX . mz0jfaypkk [ 2 ] = rtB . k1felwmdht [ 2 ] ; } rtB .
brzszdbn0r [ 0 ] = rtX . mz0jfaypkk [ 0 ] ; rtB . brzszdbn0r [ 1 ] = rtX .
mz0jfaypkk [ 1 ] ; rtB . brzszdbn0r [ 2 ] = rtX . mz0jfaypkk [ 2 ] ; rtB .
dkfmpnas3p [ 0 ] = ( mcn21s5jdx [ 0 ] - 0.57735026918962584 * mcn21s5jdx [ 3
] ) * rtP . eachwheelInertia_Value + ( rtB . fh4fxhb3dg [ 2 ] * rtB .
brzszdbn0r [ 1 ] - rtB . fh4fxhb3dg [ 1 ] * rtB . brzszdbn0r [ 2 ] ) * rtP .
eachwheelInertia_Value ; rtB . dkfmpnas3p [ 1 ] = ( mcn21s5jdx [ 1 ] -
...
eachwheelInertia_Value + ( rtB . fh4fxhb3dg [ 1 ] * rtB . brzszdbn0r [ 0 ] -
rtB . fh4fxhb3dg [ 0 ] * rtB . brzszdbn0r [ 1 ] ) * rtP .
eachwheelInertia_Value ; d [ 1 ] = 0.0 ; d [ 4 ] = muDoubleScalarCos ( rtX .
kmrvp24iak [ 2 ] ) ; d [ 7 ] = muDoubleScalarSin ( rtX . kmrvp24iak [ 2 ] ) ;
d [ 2 ] = 0.0 ; d [ 5 ] = - muDoubleScalarSin ( rtX . kmrvp24iak [ 2 ] ) ; d
[ 8 ] = muDoubleScalarCos ( rtX . kmrvp24iak [ 2 ] ) ; tmp [ 0 ] =
muDoubleScalarCos ( rtX . kmrvp24iak [ 1 ] ) ; tmp [ 3 ] = 0.0 ; tmp [ 6 ] =
- muDoubleScalarSin ( rtX . kmrvp24iak [ 1 ] ) ; d [ 0 ] = 1.0 ; tmp [ 1 ] =
0.0 ; d [ 3 ] = 0.0 ; tmp [ 4 ] = 1.0 ; d [ 6 ] = 0.0 ; tmp [ 7 ] = 0.0 ; tmp
[ 2 ] = muDoubleScalarSin ( rtX . kmrvp24iak [ 1 ] ) ; tmp [ 5 ] = 0.0 ; tmp
[ 8 ] = muDoubleScalarCos ( rtX . kmrvp24iak [ 1 ] ) ; tmp_p [ 0 ] =
muDoubleScalarCos ( rtX . kmrvp24iak [ 0 ] ) ; tmp_p [ 3 ] =
muDoubleScalarSin ( rtX . kmrvp24iak [ 0 ] ) ; tmp_p [ 6 ] = 0.0 ; tmp_p [ 1
] = - muDoubleScalarSin ( rtX . kmrvp24iak [ 0 ] ) ; tmp_p [ 4 ] =
muDoubleScalarCos ( rtX . kmrvp24iak [ 0 ] ) ; tmp_p [ 7 ] = 0.0 ; for ( i =
...
temp1 [ i ] = rtB . brzszdbn0r [ i ] - kxihzicqru ; y [ i ] = Cbo [ i + 6 ] *
0.0010741000000000001 + ( Cbo [ i + 3 ] * 0.0 + Cbo [ i ] * 0.0 ) ; } for ( i
= 0 ; i < 3 ; i ++ ) { rtB . fzngedcyzz [ i ] = rtX . kmrvp24iak [ i ] * rtP
...
rtB . dkfmpnas3p [ 0 ] ) - ( temp1 [ 1 ] * b_y [ 2 ] - temp1 [ 2 ] * b_y [ 1
] ) ; dpr3yvxfcy = ( ( rtP . disturbTorques_Value [ 2 ] + rtP . magTorq_Value
) - rtB . dkfmpnas3p [ 2 ] ) - ( temp1 [ 0 ] * b_y [ 1 ] - temp1 [ 1 ] * b_y
[ 0 ] ) ; temp1 [ 1 ] = ( ( ( rtP . disturbTorques_Value [ 1 ] + rtP .
magTorq_Value ) - rtB . dkfmpnas3p [ 1 ] ) - ( temp1 [ 2 ] * b_y [ 0 ] -
...
l0kmnfav4f [ 0 ] = rtP . uI_Gain * rtB . eg1zksfhic [ 0 ] ; rtB . l0kmnfav4f
[ 1 ] = rtP . uI_Gain * rtB . eg1zksfhic [ 1 ] ; rtB . l0kmnfav4f [ 2 ] = rtP
. uI_Gain * rtB . eg1zksfhic [ 2 ] ; rtB . l0kmnfav4f [ 3 ] = rtP . uI_Gain *
rtB . eg1zksfhic [ 3 ] ; rtB . dpmunjkbhb = rtP . Gain2_Gain * rtB .
fdz33yjl0b [ 0 ] ; rtB . mdbqqd0snu = rtP . Gain2_Gain_nggjdhdyc1 * rtB .
fdz33yjl0b [ 1 ] ; rtB . ftdouwbfxw = rtP . Gain2_Gain_cddumad5uc * rtB .
fdz33yjl0b [ 2 ] ; Cbo [ 0 ] = - muDoubleScalarSin ( dkrturai3y_idx_1 ) ; Cbo
[ 3 ] = 0.0 ; Cbo [ 6 ] = 1.0 ; Cbo [ 1 ] = muDoubleScalarCos (
dkrturai3y_idx_1 ) * muDoubleScalarSin ( dkrturai3y_idx_2 ) ; Cbo [ 4 ] =
muDoubleScalarCos ( dkrturai3y_idx_2 ) ; Cbo [ 7 ] = 0.0 ; Cbo [ 2 ] =
muDoubleScalarCos ( dkrturai3y_idx_1 ) * muDoubleScalarCos ( dkrturai3y_idx_2
) ; Cbo [ 5 ] = - muDoubleScalarSin ( dkrturai3y_idx_2 ) ; Cbo [ 8 ] = 0.0 ;
...
Cbo [ 6 + r3 ] -= Cbo [ 3 + r3 ] * Cbo [ 6 + r2 ] ; rtB . jqsj3svek0 [ 0 ] =
rtB . brzszdbn0r [ i ] ; rtB . jqsj3svek0 [ 1 ] = rtB . brzszdbn0r [ r2 ] -
rtB . jqsj3svek0 [ 0 ] * Cbo [ r2 ] ; rtB . jqsj3svek0 [ 2 ] = ( rtB .
brzszdbn0r [ r3 ] - rtB . jqsj3svek0 [ 0 ] * Cbo [ r3 ] ) - Cbo [ 3 + r3 ] *
rtB . jqsj3svek0 [ 1 ] ; rtB . jqsj3svek0 [ 2 ] /= Cbo [ 6 + r3 ] ; rtB .
jqsj3svek0 [ 0 ] -= Cbo [ 6 + i ] * rtB . jqsj3svek0 [ 2 ] ; rtB . jqsj3svek0
[ 1 ] -= Cbo [ 6 + r2 ] * rtB . jqsj3svek0 [ 2 ] ; rtB . jqsj3svek0 [ 1 ] /=
Cbo [ 3 + r2 ] ; rtB . jqsj3svek0 [ 0 ] -= Cbo [ 3 + i ] * rtB . jqsj3svek0 [
1 ] ; rtB . jqsj3svek0 [ 0 ] /= Cbo [ i ] ; UNUSED_PARAMETER ( tid ) ; } void
MdlOutputsTID1 ( int_T tid ) { rtB . adwnxz5ipz [ 0 ] = rtP . speeds_Value [
0 ] ; rtB . adwnxz5ipz [ 1 ] = rtP . speeds_Value [ 1 ] ; rtB . adwnxz5ipz [
2 ] = rtP . speeds_Value [ 2 ] ; rtB . adwnxz5ipz [ 3 ] = rtP . speeds_Value
[ 3 ] ; rtB . exnul2rleq [ 0 ] = rtP . pitchrollyawInitial_Value [ 0 ] ; rtB
. k1felwmdht [ 0 ] = rtP . initialOmega_Value [ 0 ] ; rtB . exnul2rleq [ 1 ]
= rtP . pitchrollyawInitial_Value [ 1 ] ; rtB . k1felwmdht [ 1 ] = rtP .
initialOmega_Value [ 1 ] ; rtB . exnul2rleq [ 2 ] = rtP .
pitchrollyawInitial_Value [ 2 ] ; rtB . k1felwmdht [ 2 ] = rtP .
...
case 3 : if ( rtB . l0kmnfav4f [ 0 ] < 0.0 ) { ssSetSolverNeedsReset ( rtS )
; rtDW . dqo0xdescv [ 0 ] = 1 ; } break ; case 1 : if ( rtB . l0kmnfav4f [ 0
] >= 0.0 ) { rtDW . dqo0xdescv [ 0 ] = 3 ; ssSetSolverNeedsReset ( rtS ) ; }
break ; default : ssSetSolverNeedsReset ( rtS ) ; if ( rtB . l0kmnfav4f [ 0 ]
...
rtB . l0kmnfav4f [ 0 ] > 0.0 ) { ssSetSolverNeedsReset ( rtS ) ; rtDW .
dqo0xdescv [ 0 ] = 2 ; } break ; case 2 : if ( rtB . l0kmnfav4f [ 0 ] <= 0.0
) { rtDW . dqo0xdescv [ 0 ] = 4 ; ssSetSolverNeedsReset ( rtS ) ; } break ;
default : ssSetSolverNeedsReset ( rtS ) ; if ( rtB . l0kmnfav4f [ 0 ] > 0.0 )
...
3 : if ( rtB . l0kmnfav4f [ 1 ] < 0.0 ) { ssSetSolverNeedsReset ( rtS ) ;
rtDW . dqo0xdescv [ 1 ] = 1 ; } break ; case 1 : if ( rtB . l0kmnfav4f [ 1 ]
>= 0.0 ) { rtDW . dqo0xdescv [ 1 ] = 3 ; ssSetSolverNeedsReset ( rtS ) ; }
break ; default : ssSetSolverNeedsReset ( rtS ) ; if ( rtB . l0kmnfav4f [ 1 ]
...
rtB . l0kmnfav4f [ 1 ] > 0.0 ) { ssSetSolverNeedsReset ( rtS ) ; rtDW .
dqo0xdescv [ 1 ] = 2 ; } break ; case 2 : if ( rtB . l0kmnfav4f [ 1 ] <= 0.0
) { rtDW . dqo0xdescv [ 1 ] = 4 ; ssSetSolverNeedsReset ( rtS ) ; } break ;
default : ssSetSolverNeedsReset ( rtS ) ; if ( rtB . l0kmnfav4f [ 1 ] > 0.0 )
...
3 : if ( rtB . l0kmnfav4f [ 2 ] < 0.0 ) { ssSetSolverNeedsReset ( rtS ) ;
rtDW . dqo0xdescv [ 2 ] = 1 ; } break ; case 1 : if ( rtB . l0kmnfav4f [ 2 ]
>= 0.0 ) { rtDW . dqo0xdescv [ 2 ] = 3 ; ssSetSolverNeedsReset ( rtS ) ; }
break ; default : ssSetSolverNeedsReset ( rtS ) ; if ( rtB . l0kmnfav4f [ 2 ]
...
rtB . l0kmnfav4f [ 2 ] > 0.0 ) { ssSetSolverNeedsReset ( rtS ) ; rtDW .
dqo0xdescv [ 2 ] = 2 ; } break ; case 2 : if ( rtB . l0kmnfav4f [ 2 ] <= 0.0
) { rtDW . dqo0xdescv [ 2 ] = 4 ; ssSetSolverNeedsReset ( rtS ) ; } break ;
default : ssSetSolverNeedsReset ( rtS ) ; if ( rtB . l0kmnfav4f [ 2 ] > 0.0 )
...
3 : if ( rtB . l0kmnfav4f [ 3 ] < 0.0 ) { ssSetSolverNeedsReset ( rtS ) ;
rtDW . dqo0xdescv [ 3 ] = 1 ; } break ; case 1 : if ( rtB . l0kmnfav4f [ 3 ]
>= 0.0 ) { rtDW . dqo0xdescv [ 3 ] = 3 ; ssSetSolverNeedsReset ( rtS ) ; }
break ; default : ssSetSolverNeedsReset ( rtS ) ; if ( rtB . l0kmnfav4f [ 3 ]
...
rtB . l0kmnfav4f [ 3 ] > 0.0 ) { ssSetSolverNeedsReset ( rtS ) ; rtDW .
dqo0xdescv [ 3 ] = 2 ; } break ; case 2 : if ( rtB . l0kmnfav4f [ 3 ] <= 0.0
) { rtDW . dqo0xdescv [ 3 ] = 4 ; ssSetSolverNeedsReset ( rtS ) ; } break ;
default : ssSetSolverNeedsReset ( rtS ) ; if ( rtB . l0kmnfav4f [ 3 ] > 0.0 )
...
0 ] = rtB . l0kmnfav4f [ 0 ] ; _rtXdis -> na0kwbhiuw [ 0 ] = false ; } else {
...
_rtXdot -> na0kwbhiuw [ 1 ] = rtB . l0kmnfav4f [ 1 ] ; _rtXdis -> na0kwbhiuw
...
. dqo0xdescv [ 2 ] != 4 ) ) { _rtXdot -> na0kwbhiuw [ 2 ] = rtB . l0kmnfav4f
...
na0kwbhiuw [ 3 ] = rtB . l0kmnfav4f [ 3 ] ; _rtXdis -> na0kwbhiuw [ 3 ] =
...
nuks2zj5bu [ 0 ] = rtB . l0kmnfav4f [ 0 ] ; } else { _rtZCSV -> nuks2zj5bu [
...
l0kmnfav4f [ 1 ] ; } else { _rtZCSV -> nuks2zj5bu [ 1 ] = 0.0 ; } if ( ( rtDW
...
l0kmnfav4f [ 2 ] ; } else { _rtZCSV -> nuks2zj5bu [ 2 ] = 0.0 ; } if ( ( rtDW
...
l0kmnfav4f [ 3 ] ; } else { _rtZCSV -> nuks2zj5bu [ 3 ] = 0.0 ; } } void
...
rtS ) { ssSetChecksumVal ( rtS , 0 , 3618624860U ) ; ssSetChecksumVal ( rtS ,
1 , 1741498447U ) ; ssSetChecksumVal ( rtS , 2 , 3451858621U ) ;
ssSetChecksumVal ( rtS , 3 , 800435400U ) ; } SimStruct *
...
ssSetChecksumVal ( rtS , 0 , 3618624860U ) ; ssSetChecksumVal ( rtS , 1 ,
1741498447U ) ; ssSetChecksumVal ( rtS , 2 , 3451858621U ) ; ssSetChecksumVal
( rtS , 3 , 800435400U ) ; { static const sysRanDType rtAlwaysEnabled =
