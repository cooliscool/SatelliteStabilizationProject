...
TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 0 } , { 1 , 3 , TARGET_STRING (
...
TARGET_STRING ( "Value" ) , 0 , 0 , 0 } , { 31 , TARGET_STRING (
...
"mainModel_matlab2013b_working_attitude_Tetrahedral/Integrator2" ) ,
TARGET_STRING ( "UpperSaturationLimit" ) , 0 , 2 , 0 } , { 39 , TARGET_STRING
( "mainModel_matlab2013b_working_attitude_Tetrahedral/Integrator2" ) ,
TARGET_STRING ( "LowerSaturationLimit" ) , 0 , 2 , 0 } , { 40 , TARGET_STRING
(
 "mainModel_matlab2013b_working_attitude_Tetrahedral/Attitude Controller/PID_1/Gain"
...
, & rtB . ptgoe03tvr [ 0 ] , & rtB . mpypoua0wh [ 0 ] , & rtB . ovrokjeois [
0 ] , & rtB . i1rpglh0rk [ 0 ] , & rtB . evkkq2irpt [ 0 ] , & rtB .
n4hc35vufj , & rtB . jlf40ljcp0 , & rtB . cbnfwiqn0t , & rtB . arbmarg4hj , &
rtB . nu3puwrer0 , & rtB . dd50ahg4eq , & rtB . gjb3pj0jz1 , & rtB .
aswuxjeept , & rtB . plzbbm0m0n , & rtB . epbuw5rgnc , & rtB . mb5hqohkyg , &
rtB . mjn504rlhx , & rtB . haev0shbm4 , & rtB . lx3subhkuw , & rtB .
evw2wf1zvf , & rtB . nnabu04l1n , & rtB . egzfwpp1ps , & rtB . mytiiwu2tf , &
...
rtDimensionArray } , "float" , { 720860282U , 672568504U , 1143932855U ,
4128612897U } , ( NULL ) , 0 , 0 } ; const rtwCAPI_ModelMappingStaticInfo *
