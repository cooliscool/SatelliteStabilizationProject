...
TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 0 } , { 2 , 4 , TARGET_STRING (
...
"mainModel_matlab2013b_working_attitude/speeds" ) , TARGET_STRING ( "" ) , 0
...
"Value" ) , 0 , 2 , 0 } , { 37 , TARGET_STRING (
"mainModel_matlab2013b_working_attitude/speeds" ) , TARGET_STRING ( "Value" )
, 0 , 1 , 0 } , { 38 , TARGET_STRING (
"mainModel_matlab2013b_working_attitude/Integrator2" ) , TARGET_STRING (
...
rtB . j242gvklzp [ 0 ] , & rtB . gq2cwl1lkd [ 0 ] , & rtB . ciu3iftexw [ 0 ]
, & rtB . opuriyedv5 [ 0 ] , & rtB . etpz3h2yod [ 0 ] , & rtB . feo55pwd4v [
0 ] , & rtB . orau2tzp4m [ 0 ] , & rtB . ntaykcqfbm [ 0 ] , & rtB .
jy0q2ywt2j , & rtB . ae34v1uhhb , & rtB . indmgstqaw , & rtB . jj1m4pu4xq , &
rtB . klldvinnn2 , & rtB . bs1e1pomfr , & rtB . gy3r40ngvs , & rtB .
au3ih54l51 , & rtB . h5mdsiajxq , & rtB . pnr1rsr5m2 , & rtB . mdrm0m2uev , &
rtB . ddvv2mb4q1 , & rtB . mgfx13stav , & rtB . kjlahy3veo , & rtB .
ocl3m0dxtp , & rtB . jhmk22jwb1 , & rtB . emo54xl1nm , & rtB . hgkvorfmp1 , &
...
rtDimensionArray } , "float" , { 1330104612U , 3277643329U , 1532936830U ,
3536909264U } , ( NULL ) , 0 , 0 } ; const rtwCAPI_ModelMappingStaticInfo *
