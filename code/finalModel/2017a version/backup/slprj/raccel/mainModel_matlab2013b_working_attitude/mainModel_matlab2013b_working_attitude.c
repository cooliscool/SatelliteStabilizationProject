...
ssIsFirstInitCond ( rtS ) ) { rtX . gswyw4gv0d [ 0 ] = 1000.0 ; rtX .
gswyw4gv0d [ 1 ] = 1000.0 ; rtX . gswyw4gv0d [ 2 ] = 1000.0 ; rtX .
gswyw4gv0d [ 3 ] = 1732.0 ; } rtDW . ettvxhsewb = 1 ; } void MdlStart ( void
...
initialOmega_Value [ 2 ] ; rtB . gq2cwl1lkd [ 0 ] = rtP . speeds_Value [ 0 ]
; rtB . gq2cwl1lkd [ 1 ] = rtP . speeds_Value [ 1 ] ; rtB . gq2cwl1lkd [ 2 ]
= rtP . speeds_Value [ 2 ] ; rtB . gq2cwl1lkd [ 3 ] = rtP . speeds_Value [ 3
...
rtDW . ettvxhsewb != 0 ) { rtX . gswyw4gv0d [ 0 ] = rtB . gq2cwl1lkd [ 0 ] ;
rtX . gswyw4gv0d [ 1 ] = rtB . gq2cwl1lkd [ 1 ] ; rtX . gswyw4gv0d [ 2 ] =
rtB . gq2cwl1lkd [ 2 ] ; rtX . gswyw4gv0d [ 3 ] = rtB . gq2cwl1lkd [ 3 ] ;
...
; } } } rtB . etpz3h2yod [ 0 ] = rtX . gswyw4gv0d [ 0 ] ; rtB . etpz3h2yod [
1 ] = rtX . gswyw4gv0d [ 1 ] ; rtB . etpz3h2yod [ 2 ] = rtX . gswyw4gv0d [ 2
] ; rtB . etpz3h2yod [ 3 ] = rtX . gswyw4gv0d [ 3 ] ; rtB . feo55pwd4v [ 0 ]
= rtB . opuriyedv5 [ 0 ] * rtP . radToDeg_Value ; rtB . feo55pwd4v [ 1 ] =
rtB . opuriyedv5 [ 1 ] * rtP . radToDeg_Value ; rtB . feo55pwd4v [ 2 ] = rtB
. opuriyedv5 [ 2 ] * rtP . radToDeg_Value ; rtB . jj1m4pu4xq = rtP .
Gain2_Gain * rtB . orau2tzp4m [ 0 ] ; rtB . pnr1rsr5m2 = rtP .
Gain2_Gain_nggjdhdyc1 * rtB . orau2tzp4m [ 1 ] ; rtB . jhmk22jwb1 = rtP .
Gain2_Gain_cddumad5uc * rtB . orau2tzp4m [ 2 ] ; Cbo [ 0 ] = -
...
rtDW . kgldsbhmgx [ 0 ] == 1 ) && ( rtX . gswyw4gv0d [ 0 ] >= rtP .
Integrator2_UpperSat ) ) { _rtZCSV -> lagi5bbqa4 [ 0 ] = 0.0 ; } else {
_rtZCSV -> lagi5bbqa4 [ 0 ] = rtX . gswyw4gv0d [ 0 ] - rtP .
Integrator2_UpperSat ; } if ( ( rtDW . kgldsbhmgx [ 0 ] == 2 ) && ( rtX .
gswyw4gv0d [ 0 ] <= rtP . Integrator2_LowerSat ) ) { _rtZCSV -> ggcau304xb [
0 ] = 0.0 ; } else { _rtZCSV -> ggcau304xb [ 0 ] = rtX . gswyw4gv0d [ 0 ] -
rtP . Integrator2_LowerSat ; } if ( ( rtDW . kgldsbhmgx [ 0 ] == 3 ) || (
rtDW . kgldsbhmgx [ 0 ] == 4 ) ) { _rtZCSV -> ca5inishgh [ 0 ] = rtB .
ntaykcqfbm [ 0 ] ; } else { _rtZCSV -> ca5inishgh [ 0 ] = 0.0 ; } if ( ( rtDW
. kgldsbhmgx [ 1 ] == 1 ) && ( rtX . gswyw4gv0d [ 1 ] >= rtP .
...
ntaykcqfbm [ 1 ] ; } else { _rtZCSV -> ca5inishgh [ 1 ] = 0.0 ; } if ( ( rtDW
. kgldsbhmgx [ 2 ] == 1 ) && ( rtX . gswyw4gv0d [ 2 ] >= rtP .
Integrator2_UpperSat ) ) { _rtZCSV -> lagi5bbqa4 [ 2 ] = 0.0 ; } else {
_rtZCSV -> lagi5bbqa4 [ 2 ] = rtX . gswyw4gv0d [ 2 ] - rtP .
Integrator2_UpperSat ; } if ( ( rtDW . kgldsbhmgx [ 2 ] == 2 ) && ( rtX .
gswyw4gv0d [ 2 ] <= rtP . Integrator2_LowerSat ) ) { _rtZCSV -> ggcau304xb [
2 ] = 0.0 ; } else { _rtZCSV -> ggcau304xb [ 2 ] = rtX . gswyw4gv0d [ 2 ] -
rtP . Integrator2_LowerSat ; } if ( ( rtDW . kgldsbhmgx [ 2 ] == 3 ) || (
rtDW . kgldsbhmgx [ 2 ] == 4 ) ) { _rtZCSV -> ca5inishgh [ 2 ] = rtB .
ntaykcqfbm [ 2 ] ; } else { _rtZCSV -> ca5inishgh [ 2 ] = 0.0 ; } if ( ( rtDW
. kgldsbhmgx [ 3 ] == 1 ) && ( rtX . gswyw4gv0d [ 3 ] >= rtP .
...
ntaykcqfbm [ 3 ] ; } else { _rtZCSV -> ca5inishgh [ 3 ] = 0.0 ; } } void
...
rtS ) { ssSetChecksumVal ( rtS , 0 , 1330104612U ) ; ssSetChecksumVal ( rtS ,
1 , 3277643329U ) ; ssSetChecksumVal ( rtS , 2 , 1532936830U ) ;
ssSetChecksumVal ( rtS , 3 , 3536909264U ) ; } SimStruct *
...
ssSetTFinal ( rtS , 10000.0 ) ; { static RTWLogInfo rt_DataLoggingInfo ;
...
ssSetChecksumVal ( rtS , 0 , 1330104612U ) ; ssSetChecksumVal ( rtS , 1 ,
3277643329U ) ; ssSetChecksumVal ( rtS , 2 , 1532936830U ) ; ssSetChecksumVal
( rtS , 3 , 3536909264U ) ; { static const sysRanDType rtAlwaysEnabled =
