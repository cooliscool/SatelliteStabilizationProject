...
rtP . Integrator_IC_mi1nfze151 ; rtDW . k2msqlawib = 1 ; rtX . awxsvjgvlk =
rtP . Integrator3_IC ; if ( ssIsFirstInitCond ( rtS ) ) { rtX . gswyw4gv0d [
0 ] = 104.71975511965977 ; rtX . gswyw4gv0d [ 1 ] = 104.71975511965977 ; rtX
. gswyw4gv0d [ 2 ] = 104.71975511965977 ; rtX . gswyw4gv0d [ 3 ] =
181.37461586725072 ; } rtDW . ettvxhsewb = 1 ; } void MdlStart ( void ) { {
...
initialOmega_Value [ 2 ] ; rtB . aiazydzpqj [ 0 ] = rtP . initialrpms_Value [
0 ] ; rtB . aiazydzpqj [ 1 ] = rtP . initialrpms_Value [ 1 ] ; rtB .
aiazydzpqj [ 2 ] = rtP . initialrpms_Value [ 2 ] ; rtB . aiazydzpqj [ 3 ] =
...
9 ] ; real_T tmp_p [ 9 ] ; int32_T i ; if ( rtDW . dlz4fzirji != 0 ) { rtX .
gaocubqvzp [ 0 ] = rtB . j242gvklzp [ 0 ] ; rtX . gaocubqvzp [ 1 ] = rtB .
j242gvklzp [ 1 ] ; rtX . gaocubqvzp [ 2 ] = rtB . j242gvklzp [ 2 ] ; } rtB .
opuriyedv5 [ 0 ] = rtX . gaocubqvzp [ 0 ] ; rtB . orau2tzp4m [ 0 ] = rtP .
pitchrollyawdesired_Value [ 0 ] - rtB . opuriyedv5 [ 0 ] ; rtB . opuriyedv5 [
1 ] = rtX . gaocubqvzp [ 1 ] ; rtB . orau2tzp4m [ 1 ] = rtP .
pitchrollyawdesired_Value [ 1 ] - rtB . opuriyedv5 [ 1 ] ; rtB . opuriyedv5 [
2 ] = rtX . gaocubqvzp [ 2 ] ; rtB . orau2tzp4m [ 2 ] = rtP .
...
= 0 ; i < 3 ; i ++ ) { rtB . feo55pwd4v [ i ] = rtB . opuriyedv5 [ i ] * rtP
...
] ) - rtB . iquwqtloz2 [ 2 ] ) - ( temp1 [ 0 ] * b_y [ 1 ] - temp1 [ 1 ] *
...
rtB . ciu3iftexw [ 0 ] * y [ 1 ] - rtB . ciu3iftexw [ 1 ] * y [ 0 ] ) ; rtB .
m3lvyi4r0k = rtX . awxsvjgvlk ; if ( rtDW . ettvxhsewb != 0 ) { rtX .
gswyw4gv0d [ 0 ] = rtB . aiazydzpqj [ 0 ] ; rtX . gswyw4gv0d [ 1 ] = rtB .
aiazydzpqj [ 1 ] ; rtX . gswyw4gv0d [ 2 ] = rtB . aiazydzpqj [ 2 ] ; rtX .
gswyw4gv0d [ 3 ] = rtB . aiazydzpqj [ 3 ] ; } if ( ssIsMajorTimeStep ( rtS )
) { if ( rtX . gswyw4gv0d [ 0 ] >= rtP . Integrator2_UpperSat ) { rtX .
gswyw4gv0d [ 0 ] = rtP . Integrator2_UpperSat ; } else { if ( rtX .
gswyw4gv0d [ 0 ] <= rtP . Integrator2_LowerSat ) { rtX . gswyw4gv0d [ 0 ] =
rtP . Integrator2_LowerSat ; } } if ( rtX . gswyw4gv0d [ 1 ] >= rtP .
Integrator2_UpperSat ) { rtX . gswyw4gv0d [ 1 ] = rtP . Integrator2_UpperSat
; } else { if ( rtX . gswyw4gv0d [ 1 ] <= rtP . Integrator2_LowerSat ) { rtX
. gswyw4gv0d [ 1 ] = rtP . Integrator2_LowerSat ; } } if ( rtX . gswyw4gv0d [
2 ] >= rtP . Integrator2_UpperSat ) { rtX . gswyw4gv0d [ 2 ] = rtP .
Integrator2_UpperSat ; } else { if ( rtX . gswyw4gv0d [ 2 ] <= rtP .
Integrator2_LowerSat ) { rtX . gswyw4gv0d [ 2 ] = rtP . Integrator2_LowerSat
; } } if ( rtX . gswyw4gv0d [ 3 ] >= rtP . Integrator2_UpperSat ) { rtX .
gswyw4gv0d [ 3 ] = rtP . Integrator2_UpperSat ; } else { if ( rtX .
gswyw4gv0d [ 3 ] <= rtP . Integrator2_LowerSat ) { rtX . gswyw4gv0d [ 3 ] =
rtP . Integrator2_LowerSat ; } } } rtB . etpz3h2yod [ 0 ] = rtX . gswyw4gv0d
[ 0 ] ; rtB . n1ohjrgzng [ 0 ] = rtP . speeds2_Value * rtB . etpz3h2yod [ 0 ]
; rtB . etpz3h2yod [ 1 ] = rtX . gswyw4gv0d [ 1 ] ; rtB . n1ohjrgzng [ 1 ] =
rtP . speeds2_Value * rtB . etpz3h2yod [ 1 ] ; rtB . etpz3h2yod [ 2 ] = rtX .
gswyw4gv0d [ 2 ] ; rtB . n1ohjrgzng [ 2 ] = rtP . speeds2_Value * rtB .
etpz3h2yod [ 2 ] ; rtB . etpz3h2yod [ 3 ] = rtX . gswyw4gv0d [ 3 ] ; rtB .
n1ohjrgzng [ 3 ] = rtP . speeds2_Value * rtB . etpz3h2yod [ 3 ] ; rtB .
jj1m4pu4xq = rtP . Gain2_Gain * rtB . orau2tzp4m [ 0 ] ; rtB . pnr1rsr5m2 =
rtP . Gain2_Gain_nggjdhdyc1 * rtB . orau2tzp4m [ 1 ] ; rtB . jhmk22jwb1 = rtP
. Gain2_Gain_cddumad5uc * rtB . orau2tzp4m [ 2 ] ; if ( ssIsSampleHit ( rtS ,
1 , 0 ) ) { if ( rtB . ntaykcqfbm [ 0 ] > 0.0 ) { rtDW . f4pawnt0hj [ 0 ] = 1
; } else if ( rtB . ntaykcqfbm [ 0 ] < 0.0 ) { rtDW . f4pawnt0hj [ 0 ] = - 1
; } else { rtDW . f4pawnt0hj [ 0 ] = 0 ; } rtB . cdqa1b2rvw [ 0 ] = rtDW .
f4pawnt0hj [ 0 ] ; if ( rtB . ntaykcqfbm [ 1 ] > 0.0 ) { rtDW . f4pawnt0hj [
1 ] = 1 ; } else if ( rtB . ntaykcqfbm [ 1 ] < 0.0 ) { rtDW . f4pawnt0hj [ 1
] = - 1 ; } else { rtDW . f4pawnt0hj [ 1 ] = 0 ; } rtB . cdqa1b2rvw [ 1 ] =
rtDW . f4pawnt0hj [ 1 ] ; if ( rtB . ntaykcqfbm [ 2 ] > 0.0 ) { rtDW .
f4pawnt0hj [ 2 ] = 1 ; } else if ( rtB . ntaykcqfbm [ 2 ] < 0.0 ) { rtDW .
f4pawnt0hj [ 2 ] = - 1 ; } else { rtDW . f4pawnt0hj [ 2 ] = 0 ; } rtB .
cdqa1b2rvw [ 2 ] = rtDW . f4pawnt0hj [ 2 ] ; if ( rtB . ntaykcqfbm [ 3 ] >
0.0 ) { rtDW . f4pawnt0hj [ 3 ] = 1 ; } else if ( rtB . ntaykcqfbm [ 3 ] <
0.0 ) { rtDW . f4pawnt0hj [ 3 ] = - 1 ; } else { rtDW . f4pawnt0hj [ 3 ] = 0
; } rtB . cdqa1b2rvw [ 3 ] = rtDW . f4pawnt0hj [ 3 ] ; } rtB . op2c2ayack = (
( ( rtB . cdqa1b2rvw [ 0 ] * rtB . ntaykcqfbm [ 0 ] * rtB . etpz3h2yod [ 0 ]
+ rtB . cdqa1b2rvw [ 1 ] * rtB . ntaykcqfbm [ 1 ] * rtB . etpz3h2yod [ 1 ] )
+ rtB . cdqa1b2rvw [ 2 ] * rtB . ntaykcqfbm [ 2 ] * rtB . etpz3h2yod [ 2 ] )
+ rtB . cdqa1b2rvw [ 3 ] * rtB . ntaykcqfbm [ 3 ] * rtB . etpz3h2yod [ 3 ] )
* rtP . eachwheelInertia_Value ; Cbo [ 0 ] = - muDoubleScalarSin ( rtB .
opuriyedv5 [ 1 ] ) ; Cbo [ 3 ] = 0.0 ; Cbo [ 6 ] = 1.0 ; Cbo [ 1 ] =
muDoubleScalarCos ( rtB . opuriyedv5 [ 1 ] ) * muDoubleScalarSin ( rtB .
opuriyedv5 [ 2 ] ) ; Cbo [ 4 ] = muDoubleScalarCos ( rtB . opuriyedv5 [ 2 ] )
; Cbo [ 7 ] = 0.0 ; Cbo [ 2 ] = muDoubleScalarCos ( rtB . opuriyedv5 [ 1 ] )
* muDoubleScalarCos ( rtB . opuriyedv5 [ 2 ] ) ; Cbo [ 5 ] = -
muDoubleScalarSin ( rtB . opuriyedv5 [ 2 ] ) ; Cbo [ 8 ] = 0.0 ; i = 0 ; r2 =
...
int_T tid ) { real_T * lastU ; rtDW . dlz4fzirji = 0 ; if ( rtDW . i5ihhyg3t3
== ( rtInf ) ) { rtDW . i5ihhyg3t3 = ssGetT ( rtS ) ; lastU = & rtDW .
fi3xs4xgh4 ; } else if ( rtDW . oifw0jfvcb == ( rtInf ) ) { rtDW . oifw0jfvcb
= ssGetT ( rtS ) ; lastU = & rtDW . cnrljrwq5q ; } else if ( rtDW .
i5ihhyg3t3 < rtDW . oifw0jfvcb ) { rtDW . i5ihhyg3t3 = ssGetT ( rtS ) ; lastU
= & rtDW . fi3xs4xgh4 ; } else { rtDW . oifw0jfvcb = ssGetT ( rtS ) ; lastU =
& rtDW . cnrljrwq5q ; } * lastU = rtB . ocl3m0dxtp ; if ( rtDW . ndzhnxmlbe
== ( rtInf ) ) { rtDW . ndzhnxmlbe = ssGetT ( rtS ) ; lastU = & rtDW .
pgylabzfah ; } else if ( rtDW . eakx22dv4l == ( rtInf ) ) { rtDW . eakx22dv4l
= ssGetT ( rtS ) ; lastU = & rtDW . flegpay2y0 ; } else if ( rtDW .
ndzhnxmlbe < rtDW . eakx22dv4l ) { rtDW . ndzhnxmlbe = ssGetT ( rtS ) ; lastU
= & rtDW . pgylabzfah ; } else { rtDW . eakx22dv4l = ssGetT ( rtS ) ; lastU =
& rtDW . flegpay2y0 ; } * lastU = rtB . h5mdsiajxq ; if ( rtDW . fo5jnezz0v
== ( rtInf ) ) { rtDW . fo5jnezz0v = ssGetT ( rtS ) ; lastU = & rtDW .
m2qm2lzxid ; } else if ( rtDW . ktbxjai4kr == ( rtInf ) ) { rtDW . ktbxjai4kr
= ssGetT ( rtS ) ; lastU = & rtDW . lsav5m24co ; } else if ( rtDW .
fo5jnezz0v < rtDW . ktbxjai4kr ) { rtDW . fo5jnezz0v = ssGetT ( rtS ) ; lastU
= & rtDW . m2qm2lzxid ; } else { rtDW . ktbxjai4kr = ssGetT ( rtS ) ; lastU =
& rtDW . lsav5m24co ; } * lastU = rtB . indmgstqaw ; rtDW . k2msqlawib = 0 ;
rtDW . ettvxhsewb = 0 ; if ( rtX . gswyw4gv0d [ 0 ] == rtP .
Integrator2_UpperSat ) { switch ( rtDW . kgldsbhmgx [ 0 ] ) { case 3 : if (
rtB . ntaykcqfbm [ 0 ] < 0.0 ) { ssSetSolverNeedsReset ( rtS ) ; rtDW .
kgldsbhmgx [ 0 ] = 1 ; } break ; case 1 : if ( rtB . ntaykcqfbm [ 0 ] >= 0.0
) { rtDW . kgldsbhmgx [ 0 ] = 3 ; ssSetSolverNeedsReset ( rtS ) ; } break ;
default : ssSetSolverNeedsReset ( rtS ) ; if ( rtB . ntaykcqfbm [ 0 ] < 0.0 )
{ rtDW . kgldsbhmgx [ 0 ] = 1 ; } else { rtDW . kgldsbhmgx [ 0 ] = 3 ; }
break ; } } else if ( rtX . gswyw4gv0d [ 0 ] == rtP . Integrator2_LowerSat )
{ switch ( rtDW . kgldsbhmgx [ 0 ] ) { case 4 : if ( rtB . ntaykcqfbm [ 0 ] >
0.0 ) { ssSetSolverNeedsReset ( rtS ) ; rtDW . kgldsbhmgx [ 0 ] = 2 ; } break
; case 2 : if ( rtB . ntaykcqfbm [ 0 ] <= 0.0 ) { rtDW . kgldsbhmgx [ 0 ] = 4
; ssSetSolverNeedsReset ( rtS ) ; } break ; default : ssSetSolverNeedsReset (
rtS ) ; if ( rtB . ntaykcqfbm [ 0 ] > 0.0 ) { rtDW . kgldsbhmgx [ 0 ] = 2 ; }
else { rtDW . kgldsbhmgx [ 0 ] = 4 ; } break ; } } else { rtDW . kgldsbhmgx [
0 ] = 0 ; } if ( rtX . gswyw4gv0d [ 1 ] == rtP . Integrator2_UpperSat ) {
switch ( rtDW . kgldsbhmgx [ 1 ] ) { case 3 : if ( rtB . ntaykcqfbm [ 1 ] <
0.0 ) { ssSetSolverNeedsReset ( rtS ) ; rtDW . kgldsbhmgx [ 1 ] = 1 ; } break
; case 1 : if ( rtB . ntaykcqfbm [ 1 ] >= 0.0 ) { rtDW . kgldsbhmgx [ 1 ] = 3
; ssSetSolverNeedsReset ( rtS ) ; } break ; default : ssSetSolverNeedsReset (
rtS ) ; if ( rtB . ntaykcqfbm [ 1 ] < 0.0 ) { rtDW . kgldsbhmgx [ 1 ] = 1 ; }
else { rtDW . kgldsbhmgx [ 1 ] = 3 ; } break ; } } else if ( rtX . gswyw4gv0d
[ 1 ] == rtP . Integrator2_LowerSat ) { switch ( rtDW . kgldsbhmgx [ 1 ] ) {
case 4 : if ( rtB . ntaykcqfbm [ 1 ] > 0.0 ) { ssSetSolverNeedsReset ( rtS )
; rtDW . kgldsbhmgx [ 1 ] = 2 ; } break ; case 2 : if ( rtB . ntaykcqfbm [ 1
] <= 0.0 ) { rtDW . kgldsbhmgx [ 1 ] = 4 ; ssSetSolverNeedsReset ( rtS ) ; }
break ; default : ssSetSolverNeedsReset ( rtS ) ; if ( rtB . ntaykcqfbm [ 1 ]
> 0.0 ) { rtDW . kgldsbhmgx [ 1 ] = 2 ; } else { rtDW . kgldsbhmgx [ 1 ] = 4
; } break ; } } else { rtDW . kgldsbhmgx [ 1 ] = 0 ; } if ( rtX . gswyw4gv0d
[ 2 ] == rtP . Integrator2_UpperSat ) { switch ( rtDW . kgldsbhmgx [ 2 ] ) {
case 3 : if ( rtB . ntaykcqfbm [ 2 ] < 0.0 ) { ssSetSolverNeedsReset ( rtS )
...
k2osk23xhu [ 2 ] ; _rtXdot -> awxsvjgvlk = rtB . op2c2ayack ; if ( ( rtDW .
kgldsbhmgx [ 0 ] != 3 ) && ( rtDW . kgldsbhmgx [ 0 ] != 4 ) ) { _rtXdot ->
gswyw4gv0d [ 0 ] = rtB . ntaykcqfbm [ 0 ] ; _rtXdis -> gswyw4gv0d [ 0 ] =
false ; } else { _rtXdot -> gswyw4gv0d [ 0 ] = 0.0 ; if ( ( rtDW . kgldsbhmgx
[ 0 ] == 3 ) || ( rtDW . kgldsbhmgx [ 0 ] == 4 ) ) { _rtXdis -> gswyw4gv0d [
0 ] = true ; } } if ( ( rtDW . kgldsbhmgx [ 1 ] != 3 ) && ( rtDW . kgldsbhmgx
[ 1 ] != 4 ) ) { _rtXdot -> gswyw4gv0d [ 1 ] = rtB . ntaykcqfbm [ 1 ] ;
_rtXdis -> gswyw4gv0d [ 1 ] = false ; } else { _rtXdot -> gswyw4gv0d [ 1 ] =
0.0 ; if ( ( rtDW . kgldsbhmgx [ 1 ] == 3 ) || ( rtDW . kgldsbhmgx [ 1 ] == 4
) ) { _rtXdis -> gswyw4gv0d [ 1 ] = true ; } } if ( ( rtDW . kgldsbhmgx [ 2 ]
!= 3 ) && ( rtDW . kgldsbhmgx [ 2 ] != 4 ) ) { _rtXdot -> gswyw4gv0d [ 2 ] =
rtB . ntaykcqfbm [ 2 ] ; _rtXdis -> gswyw4gv0d [ 2 ] = false ; } else {
_rtXdot -> gswyw4gv0d [ 2 ] = 0.0 ; if ( ( rtDW . kgldsbhmgx [ 2 ] == 3 ) ||
( rtDW . kgldsbhmgx [ 2 ] == 4 ) ) { _rtXdis -> gswyw4gv0d [ 2 ] = true ; } }
if ( ( rtDW . kgldsbhmgx [ 3 ] != 3 ) && ( rtDW . kgldsbhmgx [ 3 ] != 4 ) ) {
_rtXdot -> gswyw4gv0d [ 3 ] = rtB . ntaykcqfbm [ 3 ] ; _rtXdis -> gswyw4gv0d
[ 3 ] = false ; } else { _rtXdot -> gswyw4gv0d [ 3 ] = 0.0 ; if ( ( rtDW .
kgldsbhmgx [ 3 ] == 3 ) || ( rtDW . kgldsbhmgx [ 3 ] == 4 ) ) { _rtXdis ->
gswyw4gv0d [ 3 ] = true ; } } } void MdlProjection ( void ) { } void
...
rtS ) { ssSetChecksumVal ( rtS , 0 , 87242270U ) ; ssSetChecksumVal ( rtS , 1
, 580552886U ) ; ssSetChecksumVal ( rtS , 2 , 3648892907U ) ;
ssSetChecksumVal ( rtS , 3 , 1584751160U ) ; } SimStruct *
...
"mainModel_matlab2013b_working_attitude/Integrator3" ,
"mainModel_matlab2013b_working_attitude/Integrator2" } ; static const char_T
...
rt_LoggedStateSignalPtrs [ 5 ] = ( void * ) & rtX . awxsvjgvlk ;
rt_LoggedStateSignalPtrs [ 6 ] = ( void * ) & rtX . gswyw4gv0d [ 0 ] ; }
...
ssSetChecksumVal ( rtS , 0 , 87242270U ) ; ssSetChecksumVal ( rtS , 1 ,
580552886U ) ; ssSetChecksumVal ( rtS , 2 , 3648892907U ) ; ssSetChecksumVal
( rtS , 3 , 1584751160U ) ; { static const sysRanDType rtAlwaysEnabled =
