...
DataTypeTransition rtBTransitions [ ] = { { ( char_T * ) ( & rtB . jhhwutstv4
[ 0 ] ) , 0 , 0 , 39 } , { ( char_T * ) ( & rtDW . dduqlj1v4r . LoggedData )
, 11 , 0 , 2 } , { ( char_T * ) ( & rtDW . g1li03p4if ) , 10 , 0 , 7 } } ;
static DataTypeTransitionTable rtBTransTable = { 3U , rtBTransitions } ;
static DataTypeTransition rtPTransitions [ ] = { { ( char_T * ) ( & rtP .
speeds_Value [ 0 ] ) , 0 , 0 , 26 } } ; static DataTypeTransitionTable
