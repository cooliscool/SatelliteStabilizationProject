...
, 0 } , { 8 , TARGET_STRING ( "mainModel_matlab2013a/each wheel Inertia" ) ,
TARGET_STRING ( "Value" ) , 0 , 2 , 0 } , { 9 , TARGET_STRING (
"mainModel_matlab2013a/initial Omega" ) , TARGET_STRING ( "Value" ) , 0 , 1 ,
0 } , { 10 , TARGET_STRING ( "mainModel_matlab2013a/magTorq " ) ,
...
, 0 , 1 , 0 } , { 13 , TARGET_STRING ( "mainModel_matlab2013a/speeds" ) ,
TARGET_STRING ( "Value" ) , 0 , 0 , 0 } , { 14 , TARGET_STRING (
"mainModel_matlab2013a/Integrator2" ) , TARGET_STRING (
"UpperSaturationLimit" ) , 0 , 2 , 0 } , { 15 , TARGET_STRING (
"mainModel_matlab2013a/Integrator2" ) , TARGET_STRING (
...
bolfbkf5bm [ 0 ] , & rtB . f5dkugssxf [ 0 ] , & rtB . pqvw0y53rd [ 0 ] , &
rtB . imaxglwpam [ 0 ] , & rtB . lsvistcdke [ 0 ] , & rtB . nndjph3uih [ 0 ]
...
rtP . speeds_Value [ 0 ] , & rtP . Integrator2_UpperSat , & rtP .
...
rtBlockSignals , 7 , ( NULL ) , 0 , ( NULL ) , 0 } , { rtBlockParameters , 9
, rtModelParameters , 0 } , { ( NULL ) , 0 } , { rtDataTypeMap ,
rtDimensionMap , rtFixPtMap , rtElementMap , rtSampleTimeMap ,
rtDimensionArray } , "float" , { 252004669U , 3808634814U , 849449876U ,
1748155767U } , ( NULL ) , 0 , 0 } ; const rtwCAPI_ModelMappingStaticInfo *
